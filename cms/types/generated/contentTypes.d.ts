...
export interface ApiAgeGroupAgeGroup extends Struct.CollectionTypeSchema {
	...
	attributes: {
		...
		createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
		locale: Schema.Attribute.String & Schema.Attribute.Private;
		localizations: Schema.Attribute.Relation<'oneToMany', 'api::age-group.age-group'> &
			Schema.Attribute.Private;
...
export interface ApiChronikChronik extends Struct.SingleTypeSchema {
	collectionName: 'chroniks';
	info: {
		description: '';
		displayName: 'History';
		pluralName: 'chroniks';
		singularName: 'chronik';
	};
	options: {
		draftAndPublish: true;
	};
	attributes: {
		createdAt: Schema.Attribute.DateTime;
		createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
		entries: Schema.Attribute.DynamicZone<['history.history-entry']>;
		locale: Schema.Attribute.String & Schema.Attribute.Private;
		localizations: Schema.Attribute.Relation<'oneToMany', 'api::chronik.chronik'> &
			Schema.Attribute.Private;
		publishedAt: Schema.Attribute.DateTime;
...
export interface ApiDivisionDivision extends Struct.CollectionTypeSchema {
	...
	attributes: {
		...
		createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
		locale: Schema.Attribute.String & Schema.Attribute.Private;
		localizations: Schema.Attribute.Relation<'oneToMany', 'api::division.division'> &
			Schema.Attribute.Private;
		name: Schema.Attribute.String & Schema.Attribute.Required;
		publishedAt: Schema.Attribute.DateTime;
		slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
...
export interface ApiFooterSocialMediaFooterSocialMedia extends Struct.SingleTypeSchema {
	collectionName: 'footer_social_medias';
	info: {
		description: '';
		displayName: 'Footer Social Media';
		pluralName: 'footer-social-medias';
		singularName: 'footer-social-media';
	};
	options: {
		draftAndPublish: true;
	};
	attributes: {
		createdAt: Schema.Attribute.DateTime;
		createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
		items: Schema.Attribute.Component<'social-media.social-media-item', true>;
		locale: Schema.Attribute.String & Schema.Attribute.Private;
		localizations: Schema.Attribute.Relation<
			'oneToMany',
			'api::footer-social-media.footer-social-media'
		> &
			Schema.Attribute.Private;
		publishedAt: Schema.Attribute.DateTime;
		updatedAt: Schema.Attribute.DateTime;
...
export interface ApiLandingpageLandingpage extends Struct.SingleTypeSchema {
	...
	attributes: {
		...
		headline_widgets: Schema.Attribute.Component<'widget.fupa-widget', true> &
			Schema.Attribute.SetPluginOptions<{
				i18n: {
					localized: true;
				};
		...
		localizations: Schema.Attribute.Relation<'oneToMany', 'api::landingpage.landingpage'>;
		publishedAt: Schema.Attribute.DateTime;
		...
		updatedAt: Schema.Attribute.DateTime;
		updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
		Vereinsspielplan: Schema.Attribute.Component<'widget.results-fussball-de', false> &
			Schema.Attribute.SetPluginOptions<{
				i18n: {
					localized: true;
				};
...
export interface ApiMainMenuMainMenu extends Struct.SingleTypeSchema {
	...
	attributes: {
		createdAt: Schema.Attribute.DateTime;
		createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
		entries: Schema.Attribute.DynamicZone<
			[
		...
		>;
		locale: Schema.Attribute.String & Schema.Attribute.Private;
		localizations: Schema.Attribute.Relation<'oneToMany', 'api::main-menu.main-menu'> &
			Schema.Attribute.Private;
		publishedAt: Schema.Attribute.DateTime;
		updatedAt: Schema.Attribute.DateTime;
		updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
...
export interface ApiNewspaperNewspaper extends Struct.CollectionTypeSchema {
	...
	attributes: {
		...
		locale: Schema.Attribute.String & Schema.Attribute.Private;
		localizations: Schema.Attribute.Relation<'oneToMany', 'api::newspaper.newspaper'> &
			Schema.Attribute.Private;
		publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPersonPerson extends Struct.CollectionTypeSchema {
	...
	attributes: {
		...
		localizations: Schema.Attribute.Relation<'oneToMany', 'api::person.person'> &
			Schema.Attribute.Private;
		mail_public: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
		phone: Schema.Attribute.String;
		phone_public: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
		publishedAt: Schema.Attribute.DateTime;
		updatedAt: Schema.Attribute.DateTime;
		updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
	};
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
	...
	attributes: {
		...
		localizations: Schema.Attribute.Relation<'oneToMany', 'api::post.post'> &
			Schema.Attribute.Private;
		on_landingpage: Schema.Attribute.Boolean &
			Schema.Attribute.Required &
...
export interface ApiSupporterSupporter extends Struct.SingleTypeSchema {
	...
	attributes: {
		createdAt: Schema.Attribute.DateTime;
		createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
		items: Schema.Attribute.Component<'supporter.supporter-item', true>;
		locale: Schema.Attribute.String & Schema.Attribute.Private;
		localizations: Schema.Attribute.Relation<'oneToMany', 'api::supporter.supporter'> &
			Schema.Attribute.Private;
		publishedAt: Schema.Attribute.DateTime;
		updatedAt: Schema.Attribute.DateTime;
		updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
...
export interface ApiTeamTeam extends Struct.CollectionTypeSchema {
	...
	attributes: {
		age_group: Schema.Attribute.Relation<'oneToOne', 'api::age-group.age-group'>;
		content: Schema.Attribute.RichText &
			Schema.Attribute.SetPluginOptions<{
				i18n: {
					localized: true;
		...
		divisions: Schema.Attribute.Relation<'manyToMany', 'api::division.division'>;
		fupa_widget_next_game: Schema.Attribute.Component<'widget.fupa-widget', false> &
			Schema.Attribute.SetPluginOptions<{
				i18n: {
					localized: true;
				};
		...
		supervisors: Schema.Attribute.Relation<'oneToMany', 'api::person.person'>;
		trainers: Schema.Attribute.Relation<'oneToMany', 'api::person.person'>;
		training: Schema.Attribute.Component<'training.trainingslot', true> &
			Schema.Attribute.SetPluginOptions<{
				i18n: {
					localized: true;
				};
		...
		updatedAt: Schema.Attribute.DateTime;
		updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
		widgetFussballDe: Schema.Attribute.Component<'widget.results-fussball-de', true> &
			Schema.Attribute.SetPluginOptions<{
				i18n: {
					localized: true;
				};
...
declare module '@strapi/strapi' {
	export module Public {
		export interface ContentTypeSchemas {
			...
			'api::chronik.chronik': ApiChronikChronik;
			'api::division.division': ApiDivisionDivision;
			'api::footer-social-media.footer-social-media': ApiFooterSocialMediaFooterSocialMedia;
