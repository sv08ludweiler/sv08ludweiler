...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
	...
	attributes: {
		...
		role: Attribute.Relation<
			...
			'plugin::users-permissions.role'
		>;
		posts: Attribute.Relation<'plugin::users-permissions.user', 'oneToMany', 'api::post.post'>;
		name: Attribute.String & Attribute.Required;
...
export interface ApiAgeGroupAgeGroup extends Schema.CollectionType {
	...
	attributes: {
		name: Attribute.String & Attribute.Required;
		slug: Attribute.UID;
		alternativeName: Attribute.String;
		createdAt: Attribute.DateTime;
		updatedAt: Attribute.DateTime;
		publishedAt: Attribute.DateTime;
		createdBy: Attribute.Relation<'api::age-group.age-group', 'oneToOne', 'admin::user'> &
			Attribute.Private;
		updatedBy: Attribute.Relation<'api::age-group.age-group', 'oneToOne', 'admin::user'> &
			Attribute.Private;
	};
}
...
export interface ApiDivisionDivision extends Schema.CollectionType {
	...
	attributes: {
		...
		>;
		teams: Attribute.Relation<'api::division.division', 'manyToMany', 'api::team.team'>;
		createdAt: Attribute.DateTime;
		updatedAt: Attribute.DateTime;
		publishedAt: Attribute.DateTime;
		createdBy: Attribute.Relation<'api::division.division', 'oneToOne', 'admin::user'> &
			Attribute.Private;
		updatedBy: Attribute.Relation<'api::division.division', 'oneToOne', 'admin::user'> &
			Attribute.Private;
	};
}
...
export interface ApiLandingpageLandingpage extends Schema.SingleType {
	...
	attributes: {
		...
		Vereinsspielplan: Attribute.Component<'widget.results-fussball-de'> &
			Attribute.SetPluginOptions<{
				i18n: {
					localized: true;
				};
		...
		updatedAt: Attribute.DateTime;
		publishedAt: Attribute.DateTime;
		createdBy: Attribute.Relation<'api::landingpage.landingpage', 'oneToOne', 'admin::user'> &
			Attribute.Private;
		updatedBy: Attribute.Relation<'api::landingpage.landingpage', 'oneToOne', 'admin::user'> &
			Attribute.Private;
		localizations: Attribute.Relation<
...
export interface ApiMainMenuMainMenu extends Schema.SingleType {
	...
	attributes: {
		...
		updatedAt: Attribute.DateTime;
		publishedAt: Attribute.DateTime;
		createdBy: Attribute.Relation<'api::main-menu.main-menu', 'oneToOne', 'admin::user'> &
			Attribute.Private;
		updatedBy: Attribute.Relation<'api::main-menu.main-menu', 'oneToOne', 'admin::user'> &
			Attribute.Private;
	};
}
...
export interface ApiPostPost extends Schema.CollectionType {
	...
	attributes: {
		...
		content: Attribute.RichText;
		header_image: Attribute.Media;
		author: Attribute.Relation<'api::post.post', 'manyToOne', 'plugin::users-permissions.user'>;
		teams: Attribute.Relation<'api::post.post', 'oneToMany', 'api::team.team'>;
		on_landingpage: Attribute.Boolean & Attribute.Required & Attribute.DefaultTo<true>;
		createdAt: Attribute.DateTime;
		updatedAt: Attribute.DateTime;
		publishedAt: Attribute.DateTime;
...
export interface ApiTeamTeam extends Schema.CollectionType {
	...
	attributes: {
		...
		trainer: Attribute.Relation<'api::team.team', 'oneToMany', 'plugin::users-permissions.user'>;
		supervisor: Attribute.Relation<'api::team.team', 'oneToMany', 'plugin::users-permissions.user'>;
		training: Attribute.Component<'training.trainingslot', true> &
			Attribute.SetPluginOptions<{
				i18n: {
					localized: true;
				};
			}>;
		widgetFussballDe: Attribute.Component<'widget.results-fussball-de', true> &
			Attribute.SetPluginOptions<{
				i18n: {
					localized: true;
				};
			}>;
		age_group: Attribute.Relation<'api::team.team', 'oneToOne', 'api::age-group.age-group'>;
		divisions: Attribute.Relation<'api::team.team', 'manyToMany', 'api::division.division'>;
		...
		updatedAt: Attribute.DateTime;
		publishedAt: Attribute.DateTime;
		createdBy: Attribute.Relation<'api::team.team', 'oneToOne', 'admin::user'> & Attribute.Private;
		updatedBy: Attribute.Relation<'api::team.team', 'oneToOne', 'admin::user'> & Attribute.Private;
		localizations: Attribute.Relation<'api::team.team', 'oneToMany', 'api::team.team'>;
		locale: Attribute.String;
	};
}
